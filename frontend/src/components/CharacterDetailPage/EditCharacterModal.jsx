...
const EditCharacterModal = ({ character, refreshCharacter, handleNameChange, convertCm }) => {
  ...
  return (
    <div className="modal-overlay">
      ...
      <label>
      <span>Picrew URL (<a href="https://picrew.me/ja/image_maker/1669170" rel="noopener noreferrer" target="_blank">maker</a> / <a href="https://imgbb.com/" rel="noopener noreferrer" target="_blank">uploader</a>)</span>
          <input
            type="text"
            value={picrew}
