  ...
  return (
    <header className="header">
      <div className="logo-container">
        <NavLink to="/"><img src="https://i.ibb.co/pLLL4wB/logo-1.webp" alt="Logo" className="logo" /></NavLink>
      ...
      <nav>
        <ul className="header-list">
          ...
          <li>
            <NavLink to="/arts" className="header-link" activeClassName="active-link">
              Art
            </NavLink>
          </li>
        </ul>
